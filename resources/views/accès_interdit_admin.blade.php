	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url(assets/media/error/bg1.jpg);">
				...
				<p class="font-size-h3 text-muted font-weight-normal">Désolé, cette page n'est accessible que par les clients, veuillez retourner vers la page précédente</p>
				<!--end::Content-->
			</div>
			<!--end::Error-->
		</div>
